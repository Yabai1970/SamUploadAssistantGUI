    ...
    async def gather_prep(self, meta, mode):
        ...
        if conform_issues:
            ...
            if not meta['unattended'] or (meta['unattended'] and meta.get('unattended_confirm', False)):
                try:
                    upload = cli_ui.ask_yes_no("Foram encontrados erros de conformidade na MediaInfo (possível arquivo corrompido, download incompleto, novo codec etc.). Deseja prosseguir com o upload mesmo assim?", default=False)
                except EOFError:
