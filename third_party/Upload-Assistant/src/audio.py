        ...
        if meta.get('dual_audio', False):
            ...
            try:
                ...
                for t in audio_tracks:
                    ...
                    if isinstance(audio_language, str):
                        ...
                        if audio_language and not audio_language.startswith(orig_lang) and not audio_language.startswith("en") and not audio_language.startswith("zx"):
                            ...
                            console.print(f"[bold red]Esta versão possui uma faixa de áudio em {audio_language} e pode ser considerada pesada (por conter vários áudios ou arquivos extras).")
                            time.sleep(5)
                ...
                if (
                    ...
                    console.print("[bold red]Esta versão é original em inglês, possui áudio em inglês, mas também inclui outras faixas de áudio em idiomas não ingleses (não são comentários). Pode ser considerada pesada (por conter áudios extras).[/bold red]")
                    meta['bloated'] = True
                    time.sleep(5)
