        ...
        if os.path.exists(log_file):
            ...
            if new_files or removed_files:
                ...
                if not meta['unattended'] or (meta['unattended'] and meta.get('unattended_confirm', False)):
                    ...
                    edit_choice = input("Digite 'u' para atualizar, 'a' para adicionar arquivos específicos, 'e' para editar, 'd' para descartar ou pressione Enter para manter como está: ").strip().lower()
                    ...
                    if edit_choice == 'u':
                        ...
                        selected = input("Informe os números (ex.: 1,3,5): ").strip()
                        try:
                ...
                if not meta['unattended'] or (meta['unattended'] and meta.get('unattended_confirm', False)):
                    ...
                    edit_choice = input("Digite 'e' para editar, 'd' para descartar ou pressione Enter para manter como está: ").strip().lower()
            ...
            edit_choice = input("Digite 'e' para editar ou pressione Enter para salvar como está: ").strip().lower()
