...
class THR():
    ...
    async def upload(self, meta, disctype):
        ...
        if meta.get('unattended', False) is False:
            thr_confirm = cli_ui.ask_yes_no("Correto?", default=False)
            if thr_confirm is not True:
                thr_name_manually = cli_ui.ask_string("Informe um nome válido", default="")
        ...
        if meta['debug'] is False:
            ...
            thr_upload_prompt = cli_ui.ask_yes_no("Enviar para takeupload.php?", default=False)
