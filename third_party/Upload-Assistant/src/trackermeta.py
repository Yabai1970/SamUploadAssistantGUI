        ...
        if meta.get('ptp') is None:
            ...
            if ptp_torrent_id:
                ...
                if not meta['unattended']:
                    if await prompt_user_for_confirmation("Deseja usar estes dados de ID do PTP?"):
                        ...
                        if not meta.get('skipit'):
                            ...
                            if os.path.exists(nfo_file_path):
                                with open(nfo_file_path, 'r', encoding='utf-8') as nfo_file:
                                    ...
                                    edit_choice = input("Digite 'd' para descartar ou pressione Enter para manter como está: ")
